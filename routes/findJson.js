...
// 								if(tags != 0) {
// 									if((jsonData[i].languages == language) && (jsonData[i].series == "") && (jsonData[i].authors.match(compareAuthor)) && (jsonData[i].tags.match(compareTags)) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
...
// 								else {
// 									if((jsonData[i].languages == language) && (jsonData[i].series == "") && (jsonData[i].authors.match(compareAuthor)) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].languages == language) && (jsonData[i].series == "") && (jsonData[i].tags.match(compareTags)) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].languages == language) && (jsonData[i].series == "") && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].series == "") && (jsonData[i].authors.match(compareAuthor)) && (jsonData[i].tags.match(compareTags)) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].series == "") && (jsonData[i].authors.match(compareAuthor)) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].series == "") && (jsonData[i].tags.match(compareTags)) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].series == "") && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].languages == language) && (jsonData[i].authors.match(compareAuthor)) && (jsonData[i].tags.match(compareTags)) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].languages == language) && (jsonData[i].authors.match(compareAuthor)) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].languages == language) && (jsonData[i].tags.match(compareTags)) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].languages == language) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].authors.match(compareAuthor)) && (jsonData[i].tags.match(compareTags)) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if(jsonData[i].authors.match(compareAuthor) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if(jsonData[i].tags.match(compareTags) && (publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								//PublishDate + input
// 								else {
// 									if((publishDate.slice(-1)[0] <= jsonData[i].pubdate.slice(0,4)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].languages == language) && (jsonData[i].series == "") && (jsonData[i].authors.match(compareAuthor)) && (jsonData[i].tags.match(compareTags)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].languages == language) && (jsonData[i].series == "") && (jsonData[i].authors.match(compareAuthor)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].languages == language) && (jsonData[i].series == "") && (jsonData[i].tags.match(compareTags)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].languages == language) && (jsonData[i].series == "") && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].series == "") && (jsonData[i].authors.match(compareAuthor)) && (jsonData[i].tags.match(compareTags)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].series == "") && (jsonData[i].authors.match(compareAuthor)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].series == "") && (jsonData[i].tags.match(compareTags)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].series == "") && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].languages == language) && (jsonData[i].authors.match(compareAuthor)) && (jsonData[i].tags.match(compareTags)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].languages == language) && (jsonData[i].authors.match(compareAuthor)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].languages == language) && (jsonData[i].tags.match(compareTags)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].languages == language) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].authors.match(compareAuthor)) && (jsonData[i].tags.match(compareTags)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								else {
// 									if((jsonData[i].authors.match(compareAuthor)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
...
// 								if(tags != 0) {
// 									if((jsonData[i].tags.match(compareTags)) && ((jsonData[i].title.match(compareTitle)) || (jsonData[i].authors.match(compareTitle)) || (jsonData[i].tags.match(compareTitle)))) {
// 										result.push({
// 											title: jsonData[i].title,
// 											author: jsonData[i].authors,
// 											genre: jsonData[i].tags,
